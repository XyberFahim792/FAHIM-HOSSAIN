...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "Assalamulaikum I'm Cyber Fahim Apnar Jnno Ki Korte Pari?",
          "বাম বোলা Uaira যা খানকির পোলা🗣️",
          "বার বার আমাকে ডাকস কেন😡",
          "ভালো হয়ে জাও মাসুদ এখনো সময় আছে🥲",
          "হুম জান তোমার পম পম এ উম্মমাহ😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে বস নয়নকে একটা গফ দে 🙄",
          "Xann hanga korba Amar Boss Fahim er Sathe?😝",
          "Xan bal falaba🙂",
          "বাম বোলা Uaira ja khanki magir pola",
          "samne Ramadan Ekhono Somoy Ase Valo Hoo",
          "Kemon Aso Bodsho",
          "Joy Bangla 🤡",
          "Ki Hoise Mongu Ko?",
          "Lucky Nki Benson konda?"
        ];
