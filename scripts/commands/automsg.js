...
const nam = [{
    ...
    message: ['~ এখন রাত ১২টা বেজে গেলো সবাই শুয়ে পড়ো🤟']
						...
						{
    timer: '2:00:00 AM',
    message: ['~এখন রাত ১টা বাজে প্রেম না কইরা যাইয়া ঘুমা বেক্কল সামনে রোজা এখনো সময় আছে ভালো হ 😾']
},
						 {
    timer: '3:00:00 AM',
    message: ['~এখন রাত ২টা বাজে যারা ছ্যাকা খাইছে তারা জেগে আছে সালা ঘুমা না কাইন্দা🫠🫠।']
},
						 {
    timer: '4:00:00 AM',
    message: ['~এখন রাত ৩টা বাজে সবাই তাহাজ্জুদের নামাজ পরতে উঠো ❤️‍🩹✅  ']
},
						 {
    timer: '5:00:00 AM',
    ...
    message: ['~এখন সকাল ৬টা বাজে ঘুম থেকে উঠো সবাই  ']
						 ...
						 {
    timer: '8:00:00 AM',
    message: ['~এখন সকাল ৭টা বাজে সবাই ব্রেকফাস্ট করে কুরআন শরীফ পড়ো😊 ']
},
						 {
    timer: '9:00:00 AM',
    message: ['~এখন সকাল ৮ টা বাজে বইসা না থাইকা ভালো কিছু করো যা ভবিষ্যতে কাজে দিবে ']
},
             {
    timer: '10:00:00 AM',
    message: ['~এখন সকাল ৯ টা বাজে মন দিয়ে কাজ করো সবাই❤️' ]
						 ...
						 {
    timer: '11:00:00 AM',
    message: ['~এখন সকাল ১০টা বাজে সবাই FF  এ ডুকো (Uid: 2499602892) 🌚💋  ']
},
						 {
    timer: '12:00:00 PM',
    ...
    message: ['~এখন বিকাল ৫টা বাজে 😻']
						 ...
						 {
    timer: '7:00:00 PM',
    message: ['~এখন সন্ধ্যা ৬টা বাজে একটু পর মাগরিবের আযান দিবে সবাই নামাজ পড়ে নাও😍. ']
},
             {
    timer: '8:00:00 PM',
